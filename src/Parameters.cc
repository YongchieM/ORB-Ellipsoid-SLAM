...
bool whether_read_offline_object = false;
...
double car_half_length = 1.9420*1.15;
double car_half_width = 0.8143*1.15;
double car_half_height = 0.7631*1.15;
//set orientation with average angle
bool reset_orientation = false;
double orientation_thresh = 10e-5;
//loop-closing
bool loop_close = false;
