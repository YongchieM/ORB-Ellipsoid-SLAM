...
public:
    ...
    // landmarks are copied from local ellipsoids, not new-created

    // generated ellipsoid, might be shorted than yolo 2d boxes. because some 2d box might not generate 3d object.
    ...
    std::vector<MapObject *> local_ellipsoids;
    ...
    std::vector<MapObject *> ellipsoids_landmark;
    ...
    std::vector<cv::Rect> object_2d_rectangles;   // all local_ellipsoids's 2d rectangles  mainly utility/debug use
